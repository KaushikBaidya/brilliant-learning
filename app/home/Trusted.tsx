...
const Trusted = (props: Props) => {
	return (
		<section className="lg:bg-[url('../assets/bgk.png')] bg-cover w-full lg:h-full bg-center bg-no-repeat mt-10 border-b-8 border-yellow-300">
			<div className='lg:w-10/12 2xl:max-w-screen-xl mx-auto text-white'>
				<div className='grid grid-cols-1 md:grid-cols-6 content-center pt-20'>
					<div className='flex flex-col justify-center gap-y-10 col-span-2'>
						<div className='flex items-center gap-5'>
							<div className='w-10 h-10 bg-[#6366F1] flex items-center justify-center rounded-full'>
								<LiaCertificateSolid size={25} />
							</div>
							<h3 className='text-xl font-medium'>Guarnted and certified</h3>
						</div>
						<h1 className='text-6xl font-bold'>Trusted by genius people</h1>
						...
						<div className='flex items-center text-gray-100'>
							<p className='text-6xl number font-bold pr-5 border-r-2'>95%</p>
							<p className='pl-4'>students complete course successfullly</p>
						</div>
					</div>
