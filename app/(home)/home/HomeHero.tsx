...
const HomeHero = (props: Props) => {
	return (
		<main className='lg:w-10/12 2xl:max-w-screen-xl mx-auto h-full lg:pt-28'>
			<div className='grid grid-cols-1 lg:grid-cols-2 py-10'>
				<div className='w-full flex flex-col justify-center gap-10 px-5 lg:px-0'>
					<h1 className='text-3xl lg:text-[60px] leading-normal font-bold text-gray-800 mt-16'>
					...
					<div className='flex gap-4'>
						<button className='bg-violet-600 rounded-full py-4 px-6 text-white'>
							<p className='flex items-center justify-center gap-4 text-sm lg:text-lg'>
					...
					<div className='flex gap-10 my-5 lg:my-10'>
						<div>
							<h2 className='text-lg lg:text-3xl font-semibold my-2 text-gray-800 number'>
								250+
							</h2>
